...
export default function nosotros() {
    ...
    <div>
        ...
        <div className='imagen3'><img src="img/CentroSib-3-900x600.png" alt=""width={300} height={200} /> </div> 
        <div className='parrafo3'>                
            TODO LO QUE EL PACIENTE NECESITA, EN DIAGNÓSTICO Y TRATAMIENTO ODONTOLOGICO,
            DE FORMA ÁGIL Y EN UN MISMO LUGAR
        </div>
        <div className='imagen4'><img src="img/CentroSib-4-900x600.png" alt=""width={300} height={200} /> </div>
        <div className='imagen5'><img src="img/ortodoncia5.jpg" alt=""width={300} height={200} /> </div>
